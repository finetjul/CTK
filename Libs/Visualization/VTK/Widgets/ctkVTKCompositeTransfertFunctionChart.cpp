...
//#include <vtkMuratCustomCompositeControlPointsItem.h>
...
void ctkVTKCompositeTransfertFunctionChart::SetColorTransferFunction(vtkDiscretizableColorTransferFunction* function,
  ...
  controlPoints = vtkSmartPointer<vtkCompositeControlPointsItem>::New();
...
bool ctkVTKCompositeTransfertFunctionChart::MouseDoubleClickEvent(const vtkContextMouseEvent& m) {
...
bool ctkVTKCompositeTransfertFunctionChart::MouseButtonReleaseEvent(const vtkContextMouseEvent &mouse) {
	...
	std::cout << "Interaction stoppped" << std::endl;

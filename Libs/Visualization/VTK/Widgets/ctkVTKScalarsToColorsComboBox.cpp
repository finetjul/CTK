...
// --------------------------------------------------------------------------
int ctkVTKScalarsToColorsComboBox::addScalarsToColors(vtkScalarsToColors* scFunction, const QString& name)
{
  QImage img;
  ...
  {
    img = QImage(this->iconSize(), QImage::Format::Format_RGBA8888);
    img.fill(Qt::transparent);
  }

  this->addItem(QPixmap::fromImage(img), name, QVariant::fromValue<void*>(scFunction));
  return count() - 1;
}
...
// --------------------------------------------------------------------------
int ctkVTKScalarsToColorsComboBox::findScalarsToColors(vtkScalarsToColors* scFunction) const
{
  return findData(QVariant::fromValue<void*>(scFunction));
}

// --------------------------------------------------------------------------
void ctkVTKScalarsToColorsComboBox::removeScalarsToColors(vtkScalarsToColors* scFunction)
{
...
// --------------------------------------------------------------------------
void ctkVTKScalarsToColorsComboBox::setCurrentScalarsToColors(vtkScalarsToColors* scFunction)
{
...
// --------------------------------------------------------------------------
void ctkVTKScalarsToColorsComboBox::onRowsAboutToBeRemoved(const QModelIndex& parent, int first, int last)
{
